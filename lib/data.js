...
export const creditBenefits = [
  "Each consultation requires <strong class='text-[#f3bc8fcb]'>2 credits</strong> regardless of duration",
  "Credits <strong class='text-[#f3bc8fcb]'>never expire</strong> - use them whenever you need",
  "Monthly subscriptions give you <strong class='text-[#f3bc8fcb]'>fresh credits every month</strong>",
  "Cancel or change your subscription <strong class='text-[#f3bc8fcb]'>anytime</strong> without penalties",
];